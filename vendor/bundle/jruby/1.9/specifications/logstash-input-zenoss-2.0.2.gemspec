# -*- encoding: utf-8 -*-
# stub: logstash-input-zenoss 2.0.2 ruby lib
...
Gem::Specification.new do |s|
  ...
  if s.respond_to? :specification_version then
    ...
    if Gem::Version.new(Gem::VERSION) >= Gem::Version.new('1.2.0') then
      ...
      s.add_runtime_dependency(%q<logstash-input-rabbitmq>, [">= 0"])
      s.add_runtime_dependency(%q<bunny>, ["< 2.0.0"])
      ...
      s.add_dependency(%q<logstash-input-rabbitmq>, [">= 0"])
      s.add_dependency(%q<bunny>, ["< 2.0.0"])
